...
export function GeneratePage() {
  const { canGenerate, generate, answer, steps, legalReferences } = useRag();
    ...
    <div className="card">
      <div className="card-body">
        ...
        >
          ...
          <div className="col-auto">
            ...
            <input
              ...
              type="number"
              value={topK}
              onChange={(e) => setTopK(parseInt(e.target.value || "0") || 0)}
            />
          </div>
          <div className="col-auto">
            <button
        ...
        {legalReferences && legalReferences.length > 0 && (
          <div className="mt-3">
            <h3 className="h6">Legal References</h3>
